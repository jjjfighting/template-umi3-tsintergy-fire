...
/** 备用信息: http://yapi.devops.tsintergy.com/project/101094/interface/api/236981 */
export const getSdBackup = (params: {
  /** 数据点个数 */
  dataPoint: IShowMode;
  /** 开始日期 */
  startDate: Moment;
  ...
  return request(`${API_PREFIX}/api/data/public/sd/backup`, {
    params: {
      ...params,
